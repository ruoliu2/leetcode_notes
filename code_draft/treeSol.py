    ...
    for query in queries_list:
        ...
        if action == "ADD_USER":
            ...
            if user not in user_limits:
                results.append("")
                continue
            backup_data[user] = ({f: file_sizes[f]
                                 for f in user_files[user]}, set(user_files[user]))
